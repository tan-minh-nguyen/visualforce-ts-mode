...
;; Keywords   : visualforce salesforce languages tree-sitter
;; Package-Requires: ((emacs "29.1"))
;; Version    : 1.0.0
;; URL        : https://github.com/nverno/visualforce-ts-mode
...
;;; Commentary:
;;
;; Major mode for editing Salesforce Visualforce pages, powered by tree-sitter.
;;
;; Features:
;; - Multi-language syntax highlighting (HTML, CSS, JavaScript)
;; - Visualforce expression highlighting ({!...})
